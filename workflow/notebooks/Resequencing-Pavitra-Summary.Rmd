...
```{r Replicate Comparison, echo=F, warning=F, message=F, fig.width=10, fig.height=10, fig.align='center'}
...
```{r Replicate Comparison Log10, echo=F, warning=F, message=F, fig.width=10, fig.height=10, fig.align='center'}
...
```{r Replicate Comparison Color, echo=F, warning=F, message=F, fig.width=10, fig.height=10, fig.align='center'}
...
```{r Replicate Comparison Catagories, echo=F, warning=F, message=F, fig.width=10, fig.height=10, fig.align='center'}
...
```{r Replicate Disparity, echo=F, warning=F, message=F, fig.width=6, fig.height=6, fig.align='center'}
...
metadata.df %>% 
  ...
  xlab("Reads Mapped") +
  ggtitle("Relationship between SARS2 % and Reads Mapping") +
  scale_color_manual(values = quality.colors) +
  theme_classic() +
  theme(legend.position="bottom", legend.box = "horizontal") +
  theme(legend.box.background = element_rect(colour = "black")) +
