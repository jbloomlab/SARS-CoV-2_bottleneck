...
This was the first exclusion criteria for samples in the experiment. They had to have at least 200 reads covering 80% of the genomes. Samples with less completeness were excluded. This should be one of the first supplemental figures in the paper. 
...
ggsave("../../config/figures/supplemental-1-A.svg", device = svg(), width = 11, height = 5)
...
These are the samples that failed our quality control. The coverage was less than 200X in 20% of the genome.
```{r Failed QC}
...
This leads to the exclusion of 10 people: 10136, 10027, 10091, 10106, 10138, 10110, 10107, 10028, 10114, and 10039
...
This will be the second supplemental figure. It's good for both showing the pattern of coverage over the genome, and the samples that failed our filters. 
...
ggsave("../../config/figures/supplemental-2.svg", device = svg(), width = 20, height = 20)
