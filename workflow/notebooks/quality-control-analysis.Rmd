...
The goal of this notebook is assess some of the non-coverage related aspects of library quality. I also look at some of the background data, including Ct values for each sample, the number of people who were infected on the boat, and more. This notebook provides background and context for the outbreak samples.
